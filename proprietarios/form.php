    ...
    <body>
        ...
        <div class='container'>
            ...
            <div class='col-sm-12 page-title'>
                <h3>Cadastro de Proprietario</h3>
            </div>
                <div class='col-sm-12'>
                    <form class='form' method='POST' action='proprietario-action.php '>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="dia_repasse" class="form-label">Dia de repasse:</label>
                            <input type="text" name='dia_repasse' required class="form-control" id="dia_repasse" placeholder="1">
                        </div>
                        <div class="mb-3">
